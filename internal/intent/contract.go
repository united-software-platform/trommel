...
type Contract struct {
	...
	// Facts — состав среза фактов о коде: уровни разбора, собираемые фазой
	// подготовки до исполнения правил. Умолчания у состава нет намеренно: правило,
	// требующее фактов, при незаполненном разделе даёт отказ, а не проверяется
	// на пустом срезе.
